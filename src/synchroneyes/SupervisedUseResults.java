...
/**
 * This class creates the graphics for the result frame of supervised use
 *
...
public class SupervisedUseResults{
     ...
     * @param wrongAnswers array that contains which plates user answered wrong
     ...
     */
    public SupervisedUseResults(int result,int fifteenFirstPlatesResult, String redGreenColourBlind,String[]wrongAnswers, String[] userGivenAnswers, String[] correctResults){
        ...
        String resultText;
        resultText = "Patient has completed the test giving " + String.valueOf(result) + "/24 correct answers.";
        String resultText1;
        ...
        String resultText3;
        if (result !=24){
            resultText3 = "Patient answered wrong to the plates: ";
            String plate;
            for(int i = 0; i < 24; i++){
                if(wrongAnswers[i] != null){
                    plate = wrongAnswers[i];
                    plate = plate.concat(", ");
                    resultText3 = resultText3.concat(plate);
                }
            }
        }else{
            resultText3 = "";
        ...
        String resultText4;
        resultText4 = "If there is any doubt whether patient has deficient";
        String resultText5;
        resultText5 = "colour vision it is suggested that he/she should take";
        String resultText6;
        resultText6 = "other colour vision tests, including the anomaloscope.";
        ...
        JLabel textLabel4 = new JLabel(resultText4);
        JLabel textLabel5 = new JLabel(resultText5);
        JLabel textLabel6 = new JLabel(resultText6);
        ...
        textLabel3.setFont(new Font("Serif", Font.PLAIN, 16));
        textLabel4.setFont(new Font("Serif", Font.PLAIN, 20));
        textLabel5.setFont(new Font("Serif", Font.PLAIN, 20));
        textLabel6.setFont(new Font("Serif", Font.PLAIN, 20));
        ...
        textLabel4.setVerticalAlignment(SwingConstants.CENTER);
        textLabel5.setHorizontalAlignment(SwingConstants.CENTER);
        textLabel5.setVerticalAlignment(SwingConstants.CENTER);
        textLabel6.setHorizontalAlignment(SwingConstants.CENTER);
        textLabel6.setVerticalAlignment(SwingConstants.CENTER);
        ...
        labels.add(textLabel4);
        labels.add(textLabel5);
        labels.add(textLabel6);
