...
public class PersonalUse {
    private String[] userGivenAnswers = new String[24]; // array that contains the answer that user gave for each plate
     ...
     */
    public PersonalUse(String[] userAnswers,String[][] results){
        ...
        PersonalUseResults pur = new PersonalUseResults(totalTestResults, fifteenFirstPlatesResult,redGreenColourBlind, userGivenAnswers, correctResults);
    }
